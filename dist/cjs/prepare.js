 ...
 * @returns a promise resolving to a new file and is metadata (otherwise a validation error)
 */
var imagePrepare = exports.imagePrepare = function imagePrepare(blob, options) {
  return new Promise(/*#__PURE__*/function () {
    var _ref5 = (0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee(resolve, reject) {
